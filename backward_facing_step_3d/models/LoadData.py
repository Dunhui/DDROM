...
class LoadData(object):
	...
	def get_velocity_data(self, path):
		...
		if os.path.exists('/home/ray/Documents/github_code/backward_facing_step_3d/data/Velocity.npy'):
			velocity = np.load('/home/ray/Documents/github_code/backward_facing_step_3d/data/Velocity.npy')
		else:
			vtu_num = self.get_vtu_num(path)
			for n in range(vtu_num): 
				filename = path + "/backward_facing_step_3d_" + str(n)+ ".vtu" # set name of vtu files
			...
			np.save('/home/ray/Documents/github_code/backward_facing_step_3d/data/Velocity.npy',velocity)
	...
	# call functions to load data
		...
		Velocity = np.load('/home/ray/Documents/github_code/backward_facing_step_3d/data/Velocity_uvw.npy') \
		if os.path.exists('/home/ray/Documents/github_code/backward_facing_step_3d/data/Velocity_uvw.npy') \
