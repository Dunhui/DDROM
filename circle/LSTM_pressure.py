...
def train_pressure_model(pressure):
	...
	if not os.path.exists('pre_lstm.h5'):
		encoder_model = '/home/ray/Documents/ae-for-cfd-master/src/Autoencoder/pre_encoder.h5'
		train, test = process_code_for_LSTM(pressure, encoder_model, sequence_length, LSTM_rate)
